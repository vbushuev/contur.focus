...
if(isset($_REQUEST["code"])){// get access_token
	$code = $_REQUEST["code"];
...
elseif(isset($_REQUEST["refresh"])){// refresh auth
	$params = array(
...
<form action="" method="post">
	<input type="text" name="portal" placeholder="Адрес портала" value="<?php echo $domain;?>">
